...
const ShortList = () => {
  ...
  const chef = [
    {
      id: 1,
      img: "assets/frontend/images/shortList/1.jpg",
    ...
    {
      id: 2,
      img: "assets/frontend/images/shortList/2.jpg",
      name: "Mr Alquraish Sharkar",
      rating: "4.5 (125)",
      day: "2 Jan - 10 Jan (9 days)",
    },
  ...
  const runner = [
    {
      id: 2,
      img: "assets/frontend/images/shortList/3.jpg",
    ...
    {
      id: 3,
      img: "assets/frontend/images/shortList/4.jpg",
    ...
    {
      id: 4,
      img: "assets/frontend/images/shortList/5.jpg",
      name: "Anada Aniana",
      rating: "4.5 (125)",
      day: "2 Jan - 10 Jan (9 days)",
    },
  ...
  const security = [
    {
      id: 5,
      img: "assets/frontend/images/shortList/6.jpg",
      name: "Mr Alquraish Sharkar",
      rating: "4.5 (125)",
      day: "2 Jan - 10 Jan (9 days)",
    },
    ...
    <div className="my-5">
      ...
      <div className="container px-0">
        <div className="mt-2 container-style mb-4">
          <div className="mb-3 d-flex align-items-center">
            <img
              src="assets/frontend/images/shortList/icons/runner.png"
              width={26}
              height={26}
              alt=""
            />
      ...
      <div className="container px-0">
        <div className="mt-2 container-style mb-4">
          <div className="mb-3 d-flex align-items-center">
            <img
              src="assets/frontend/images/shortList/icons/security.png"
              width={26}
              height={26}
              alt=""
            />
